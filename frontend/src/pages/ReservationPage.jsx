  ...
  const reservations = [
    {
      ...
      author: 'Matt Haig',
      reslookupedDate: new Date(2024, 8, 15),
      coverImage: '📚',
      status: 'active',
      position: 1,
      estimatedDate: new Date(2024, 8, 22),
      category: 'Fiction',
    },
    {
      id: 2,
      title: 'Atomic Habits',
      author: 'James Clear',
      reservedDate: new Date(2024, 8, 10),
      coverImage: '📖',
      status: 'active',
      position: 3,
      estimatedDate: new Date(2024, 8, 25),
      category: 'Self-Help',
    },
    {
      id: 3,
      ...
      reservedDate: new Date(2024, 7, 28),
      coverImage: '📕',
      status: 'ready',
      position: 0,
      estimatedDate: new Date(2024, 8, 20),
      category: 'Biography',
      daysToPickup: 2,
    },
    {
      ...
      reservedDate: new Date(2024, 7, 10),
      coverImage: '📘',
      status: 'completed',
      position: 0,
      completedDate: new Date(2024, 8, 5),
      category: 'Psychology',
    },
    {
      id: 5,
      ...
      author: 'Eric Ries',
      reservedDate: new Date(2024, 7, 5),
      coverImage: '📗',
      status: 'completed',
      position: 0,
      completedDate: new Date(2024, 7, 28),
      category: 'Business',
    },
  ];
