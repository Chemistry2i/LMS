  ...
  const borrowingHistory = [
    {
      ...
      author: 'Matt Haig',
      isbn: '978-0020195368',
      borrowedDate: new Date(2024, 5, 15),
      returnedDate: new Date(2024, 6, 1),
      daysOverdue: 0,
      status: 'returned',
      fineAmount: 0,
      coverImage: '📚',
    },
    {
      ...
      author: 'James Clear',
      isbn: '978-0735211292',
      borrowedDate: new Date(2024, 6, 5),
    ...
    },
    {
      ...
      isbn: '978-0399590504',
      borrowedDate: new Date(2024, 7, 20),
      returnedDate: null,
      daysOverdue: 5,
      status: 'overdue',
      fineAmount: 5000,
    ...
    },
    {
      ...
      author: 'Eric Ries',
      isbn: '978-0307887894',
      borrowedDate: new Date(2024, 4, 10),
      returnedDate: new Date(2024, 5, 10),
      daysOverdue: 0,
      status: 'returned',
      fineAmount: 0,
      coverImage: '📗',
    },
    {
      ...
      isbn: '978-0374275631',
      borrowedDate: new Date(2024, 8, 1),
      returnedDate: null,
      daysOverdue: 0,
      status: 'active',
      fineAmount: 0,
